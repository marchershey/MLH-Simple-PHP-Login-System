<?php
  ...
  require_once '../php/register/submit.register.php';
?>
          ...
          <div class="card mx-1">
            <div class="card-body p-4">
              <form action="register.php" method="post">
                ...
                <p class="text-muted text-center pb-2">Create a <?=$global['site']['name'];?> account.</p>
                ...
                <fieldset class="form-group">
                  <div class="input-group mb-1">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="Password" aria-label="password" aria-describedby="passwordIcon" value="" required>
                  </div>
                  <!-- /.input-group -->
                </fieldset>
                ...
                <fieldset class="form-group">
                  <div class="input-group mb-1">
                    <div class="input-group-prepend">
                      <span class="input-group-text" id="confirmIcon"><i class="icon-lock"></i></span>
                    </div>
                    <input type="password" name="confirm" class="form-control" placeholder="Re-type Password" aria-label="confirm" aria-describedby="confirmIcon" value="" required>
                  </div>
                  <!-- /.input-group -->
                </fieldset>
